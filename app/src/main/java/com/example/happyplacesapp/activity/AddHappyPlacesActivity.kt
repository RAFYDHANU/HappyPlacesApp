...
import com.example.happyplacesapp.util.GetAddressFromLatLng
...
class AddHappyPlacesActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun requestNewLocation(){
        ...
        mFusedLocationClient.requestLocationUpdates(mLocationRequest, mLocatiobCallback, Looper.myLooper())
    }
    // untuk get alamat melalui GPS Hp Client
    private val mLocatiobCallback = object  : LocationCallback(){
